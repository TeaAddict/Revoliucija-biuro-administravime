...
const discussionThemes = [
  {
    number: 1,
    title:
      "Mokymasis per patirtį: simuliacijos ir praktinės užduotys biuro administravimo mokyme",
    theses: [
  ...
  },
  {
    number: 2,
    title:
      "Biuro administratoriaus vaidmuo moderniame darbo pasaulyje: iššūkiai ir ateities tendencijos",
    theses: [
